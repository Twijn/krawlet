...
export default {
	...
	settings: {
		...
		cacheOverview: 'Storage Overview',
		cacheTitle: 'Manage local app caches',
		cacheSubtitle:
			'Inspect and clear IndexedDB, localStorage, and service worker cache data used by Krawlet.',
		cacheTotalEntries: 'Total Entries',
		cacheEstimatedSize: 'Estimated Size',
		cacheBuckets: 'Cache Buckets',
		cacheHeaviest: 'Heaviest Caches',
		cacheRefresh: 'Refresh',
		cacheEmpty: 'No cache data found yet.',
		cacheEntries: 'entries',
		cacheIndexedDb: 'IndexedDB Data',
		cacheLocalStorage: 'localStorage Data',
		cacheServiceWorker: 'Service Worker Caches',
		cacheClearAll: 'Clear All',
		cacheClear: 'Clear',
		cacheNoneForCategory: 'No cache entries in this category.',
		cacheUpdated: 'Updated',
		cacheDangerZone: 'Danger Zone',
		cacheDangerZoneHint:
			'Clears all app cache layers at once. This does not remove your wallets in settings.',
		cacheClearEverything: 'Clear Everything',
		cacheNever: 'Never',
		cacheHealthHeavy:
			'Large cache footprint detected. Consider clearing old entries if the app feels slow.',
		cacheHealthGood: 'Cache size is healthy.',
		cacheStatsFailed: 'Failed to load cache stats.',
		cacheActionFailed: 'Could not complete cache action.',
		cacheConfirmStore: 'Clear IndexedDB store "{store}"?',
		cacheStoreCleared: 'Cleared IndexedDB store "{store}".',
		cacheConfirmIdbAll: 'Clear all IndexedDB cache stores?',
		cacheIdbCleared: 'Cleared all IndexedDB cache stores.',
		cacheConfirmLocalKey: 'Clear localStorage cache "{key}"?',
		cacheLocalCleared: 'Cleared localStorage cache "{key}".',
		cacheConfirmLocalAll: 'Clear all localStorage caches used by Krawlet?',
		cacheLocalAllCleared: 'Cleared all localStorage caches.',
		cacheConfirmSwKey: 'Clear service worker cache "{cache}"?',
