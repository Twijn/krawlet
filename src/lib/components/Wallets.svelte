<script lang="ts">
	...
	function deleteWallet(wallet: Wallet) {
		if (confirm(`Are you sure you want to delete the wallet ${wallet.name} (${wallet.address})? This action is irreversible!`)) {
...
<Section {lgCols} {mdCols} {smCols}>
	...
	<div class="wallets">
		...
		{#each $walletStore.wallets as wallet (wallet.address)}
			...
			<div class="wallet" transition:fade|local={{duration: 200}} animate:flip={{duration: 200}}>
				<div class="icon">
