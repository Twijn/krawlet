<script lang="ts">
	import { canBuyListing, getItemImageUrl, getListingBuyLink, type ItemListing } from '$lib/stores/shopsync';
	...
	<div class="badges">
			{#if item.shopBuysItem}
							<span
								...
								title="This shop purchases this item rather than selling it">Sell Shop</span
							>
			{/if}
