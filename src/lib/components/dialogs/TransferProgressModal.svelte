<script lang="ts">
    ...
    $effect(() => {
        ...
        const interval = setInterval(fetchTransfer, 500);
...
<Modal {open} title="Transfer Progress" onClose={handleClose}>
    ...
    {:else if transfer}
        <section class="progress-card">
            ...
            <div class="bar" role="progressbar" aria-valuemin={0} aria-valuemax={100} aria-valuenow={progressPercent}>
            ...
            <div class="stats">
                ...
                <p>
                    ...
                    <span class="value">{quantityTransferred.toLocaleString()} / {quantityRequested.toLocaleString()}</span>
                </p>
                {#if transfer.error}
                    <p class="error"><span class="label">Error</span> <span class="value">{transfer.error}</span></p>
                {/if}
            </div>

            {#if loading}
                <p class="muted">Refreshing every 500 ms...</p>
            {/if}
        </section>
    {/if}
</Modal>
