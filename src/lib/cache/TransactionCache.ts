...
export class TransactionCache extends KromerCache<TransactionCacheLookup, TransactionCacheResult> {
    ...
    private filterAndSort(transactions: TransactionWithMeta[], params: TransactionCacheLookup): TransactionCacheResult {
    ...
    protected async getFromCache(params: TransactionCacheLookup): Promise<TransactionCacheResult | null> {
